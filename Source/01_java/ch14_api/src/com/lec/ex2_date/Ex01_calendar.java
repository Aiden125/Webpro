...
public class Ex01_calendar {
	public static void main(String[] args) {
		...
		System.out.printf("%tY년 %tm월 %td일 %ta요일 %tp %t1시 %tM분  %tS초", cal, cal, cal, cal, cal, cal, cal, cal);
		System.out.printf("%1$tY년 %1$tm월 %1$td일 %1$ta요일 %1$tp %1$t1시 %1$tM분 %1$tS초", cal);
	}
}

...
<body>
	...
	<form action="update.do" method="post">
		...
		<table>
			...
			<tr>
				<th>급여</th>
				<td><input type="number" name="sal" value="${empDto.sal }">
			</tr>
			<tr>
				<th>상여</th>
				<td><input type="number" name="comm" value="${empDto.comm }">
			</tr>
			<tr>
				<th>부서번호</th>
				<td><input type="number" name="deptno" value="${empDto.deptno }">
			</tr>
			<tr>
				<td colspan="2">
					<input type="submit" value="수정" class="btn">
					<input type="button" value="목록" class="btn" onclick="location.href='empDeptList.do?pageNum=${param.pageNum}'">
				</td>
			</tr>
		</table>
	</form>

...
public class FreeBoardDto {
	...
	public FreeBoardDto(int bno, String mid, int bmbti, String btitle, String bcontent, String bfilename, Date brdate,
	...
	public void setBmbti(int bmbti) {
		this.bmbti = bmbti;
	}

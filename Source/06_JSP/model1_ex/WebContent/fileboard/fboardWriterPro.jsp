...
<% 	String path = request.getRealPath("fileboardUpload");
	...
	try{
		...
		ffilename = mRequest.getFilesystemName(param); // 파일첨부 안하면 null
	}catch(IOException e){
	...
	if(ffilename!=null){ // 서버에서 소스 폴더로 파일 복사
		...
		try{
			...
			os = new FileOutputStream("D:/Webpro/Source/06_JSP/model1_ex/WebContent/fileboardUpload"+ffilename);
	...
	FileboardDto fbDto = new FileboardDto(fnum, cid, fsubject, fcontent, ffilename,
					fpw, 0, fref, fre_step, fre_level, fip, null);
...
<%
	...
	//int fnum, String cid, String fsubject, String fcontent, String ffilename, String fpw, int fhit,

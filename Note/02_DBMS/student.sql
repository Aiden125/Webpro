...
--학생입력쿼리
INSERT INTO STUDENT VALUES(TO_CHAR(SYSDATE, 'YYYY')||LPAD(STUDENT_SQ.NEXTVAL, 3, 0), 4, '음치킨', 95, 0);

--학생수정쿼리
UPDATE STUDENT SET MNO=3, SNAME='홍차차', SCORE=10, SEXPEL=1 WHERE SNO=2022011;
